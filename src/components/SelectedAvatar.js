...
class SelectedAvatar extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({myavatar: myavatardata})
    ...
    render() {
        var name = this.state.myavatar && this.state.myavatar[0]
            ? this.state.myavatar[0].name
            : '';
        var desc = this.state.myavatar && this.state.myavatar[0]
            ? this.state.myavatar[0].about
            : '';
        var id = this.state.myavatar && this.state.myavatar[0]
            ? this.state.myavatar[0].id
            : '';
        var imgUrl = '';
            ...
            <div className="selected_avatar animated zoomIn">
                <div className="selected_avatar_wrapper">
                    <div className="back" onClick={this.goback}>
                        <span className="back_icon"></span>Go Back</div>
